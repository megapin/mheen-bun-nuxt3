...
<template>
	<!-- <div class="wrap"> -->
		<header class="page-header">
			...
			<nav class="menu">
				<ol>
					<li class="menu-item"><NuxtLink to="#0">Home</NuxtLink></li>
					<li class="menu-item"><NuxtLink to="#0">About</NuxtLink></li>
					<li class="menu-item">
						<NuxtLink to="#0">Canvas</NuxtLink>
						<ol class="sub-menu">
							<li class="menu-item" v-for="item in menu.canvas"><NuxtLink :to="`/canvas/${item}`">{{item}}</NuxtLink></li>
						</ol>
					</li>
					<li class="menu-item">
						<NuxtLink to="#0">SVG</NuxtLink>
						<ol class="sub-menu">
							<li class="menu-item" v-for="item in menu.svg"><NuxtLink :to="`/svg/${item}`">{{item}}</NuxtLink></li>
						</ol>
					</li>
					<li class="menu-item"><NuxtLink to="#0">Contact</NuxtLink></li>
				</ol>
			</nav>
		</header>
	<!-- </div> -->
